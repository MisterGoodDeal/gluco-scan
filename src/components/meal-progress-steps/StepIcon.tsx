...
import type { StepIconProps } from 'react-native-progress-steps/dist/types';
...
const StepIcon = ({
  ...
  }, [isCompletedStep, isActiveStep, lineAnimationValue]);
    ...
    <View style={styles.container}>
      <View style={styles.lineContainer}>
        ...
        <View
          ...
          {isCompletedStep ? (
            <Check size={18} color={completedCheckColor} strokeWidth={2.5} />
          ) : (
